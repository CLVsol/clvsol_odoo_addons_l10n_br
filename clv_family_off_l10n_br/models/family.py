            ...
            if (family_off.reg_state in ['draft', 'revised']) and \
               (family_off.related_person_id.id is not False):
                ...
                if family_off.related_person_id.ref_address_id.id is not False:
                    ...
                    data_values['number'] = family_off.related_person_id.ref_address_id.number
                    ...
                    data_values['l10n_br_city_id'] = family_off.related_person_id.ref_address_id.l10n_br_city_id.id
