...
class CMEDMedicamentListFileUpload(models.TransientModel):
    _name = 'clv.cmed.medicament.list.file_upload'
    ...
    @api.multi
    def do_cmed_medicament_list_file_upload(self):
        self.ensure_one()
        ...
        cmed_medicament_list.directory_id = file_system_directory.id
        cmed_medicament_list.stored_file_name = self.file_name
        cmed_medicament_list.file_name = self.file_name
